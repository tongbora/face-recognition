export function FacePanel({ label, score }: { label: string; score: string }) {
  return (
    <div className="relative min-h-56 w-full min-w-0 overflow-hidden rounded-lg border border-stone-300 bg-stone-100 p-5 shadow-sm">
      ...
      <div className="mt-5 flex min-w-0 items-center justify-between gap-3 text-sm">
        ...
        <span className="shrink-0 rounded-full bg-primary-soft px-3 py-1 font-mono text-xs font-bold text-primary-dark">
          {score}
        </span>
      </div>
    </div>
